...
Self-hosted Carbon runs under **AGPLv3**: it's free to run and change, and if you let others use a modified copy over a network, you must offer them its source. A commercial license is required to use Business features (anything in `packages/ee`) or to keep your changes private from the people who use them. See [Licensing](/docs/platform/licensing).
</Callout>
